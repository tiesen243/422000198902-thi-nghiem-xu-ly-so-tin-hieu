...
MCBSP_Config AIC23CfgData = {
    ...
    MCBSP_FMKS(XCR, XPHASE, SINGLE) | MCBSP_FMKS(XCR, XFRLEN2, DEFAULT) | MCBSP_FMKS(XCR, XWDLEN2, DEFAULT) | MCBSP_FMKS(XCR, XCOMPAND, MSB) | MCBSP_FMKS(XCR, XFIG, NO) | MCBSP_FMKS(XCR, XDATDLY, 0BIT) | MCBSP_FMKS(XCR, XFRLEN1, OF(0)) | // This changes to 1 FRAME
    ...
    MCBSP_RCERE2_DEFAULT, MCBSP_RCERE3_DEFAULT, MCBSP_XCERE0_DEFAULT,
    MCBSP_XCERE1_DEFAULT, MCBSP_XCERE2_DEFAULT, MCBSP_XCERE3_DEFAULT,
...
DSK6416_AIC23_Config config = {
    ...
    /* LRS     0          simultaneous left/right volume: disabled */ /* LIM     0          left line input mute: disabled */
    /* XX      00         reserved */
    /* LIV     10111      left line input volume: 0 dB */

    0x0017,                                                           /* Set-Up Reg 1       Right line input channel volume control */
    /* RLS     0          simultaneous right/left volume: disabled */ /* RIM     0          right line input mute: disabled */
    /* XX      00         reserved */
