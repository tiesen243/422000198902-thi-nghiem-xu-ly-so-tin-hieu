...
DSK6416_AIC23_Config config = {
    0x0017, /* Set-Up Reg 0       Left line input channel volume control */ /* LRS     0          simultaneous left/right volume: disabled */ /* LIM     0          left line input mute: disabled */ /* XX      00         reserved */ /* LIV     10111      left line input volume: 0 dB */
    ...
    0x01f9, /* Set-Up Reg 3       Right channel headphone volume control */ /* RLS     1          simultaneous right/left volume: enabled */ /* RZC     1          right channel zero-cross detect: enabled */ /* RHV     1111001    right headphone volume: 0 dB */

    0x0011, /* Set-Up Reg 4       Analog audio path control */ /* X       0          reserved */ /* STA     00         sidetone attenuation: -6 dB */ /* STE     0          sidetone: disabled */ /* DAC     1          DAC: selected */ /* BYP     0          bypass: off */ /* INSEL   0          input select for ADC: line */ /* MICM    0          microphone mute: disabled */ /* MICB    1          microphone boost: enabled */
